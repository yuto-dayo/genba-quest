...
**Compatible with:** Claude, Codex, and other agents that support the agent skills specification.
...
- **docs/figma-integration.md**: Guide for using this skill with Figma MCP (Claude Code, Codex)
