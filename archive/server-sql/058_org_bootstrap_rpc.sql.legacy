-- ============================================================
-- 058: Org bootstrap RPC + case-insensitive slug uniqueness
-- ============================================================
-- 目的:
--   1) 初回未所属ユーザー向けの org bootstrap を 1 transaction で実行する
--   2) organizations.slug の case-insensitive uniqueness を保証する
-- ============================================================
...
COMMENT ON FUNCTION public.bootstrap_org(uuid, text, text) IS
  'Bootstrap a first organization and creator membership in one transaction.';
